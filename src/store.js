...
import { saveToLocal, removeFromLocal, getFromLocal } from "./utils/helper";
	...
	actions: {
	  	login({commit}, user){
	        return new Promise((resolve, reject) => {
	            commit('auth_request')
	            axios({url: 'https://shecludedapi.herokuapp.com/api/v1/shecluded/applicant/login', data: user, method: 'POST' })
	            .then(resp => {
